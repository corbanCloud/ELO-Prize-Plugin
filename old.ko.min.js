...
//KO FileUploadBindings
!function(e){"function"==typeof require&&"object"==typeof exports&&"object"==typeof module?e(require("knockout"),require("jquery")):"function"==typeof define&&define.amd?define(["knockout","jquery"],e):e(ko,jQuery)}(function(e,t){var a={customFileInputSystemOptions:{wrapperClass:"custom-file-input-wrapper",fileNameClass:"custom-file-input-file-name",buttonGroupClass:"custom-file-input-button-group",buttonClass:"custom-file-input-button",clearButtonClass:"custom-file-input-clear-button",buttonTextClass:"custom-file-input-button-text"},defaultOptions:{wrapperClass:"input-group",fileNameClass:"disabled form-control",noFileText:"No file chosen",buttonGroupClass:"input-group-btn",buttonClass:"btn btn-primary",clearButtonClass:"btn btn-default",buttonText:"Choose File",changeButtonText:"Change",clearButtonText:"Clear",fileName:!0,clearButton:!0,onClear:function(e){"function"==typeof e.clear&&e.clear()}}},s=window.URL||window.webkitURL;return e.bindingHandlers.fileInput={init:function(a,n){a.onchange=function(){var r=e.utils.unwrapObservable(n())||{};r.dataUrl&&(r.dataURL=r.dataUrl),r.objectUrl&&(r.objectURL=r.objectUrl),r.file=r.file||e.observable();var l=this.files[0];l&&r.file(l),r.clear||(r.clear=function(){t.each(["file","objectURL","base64String","binaryString","text","dataURL","arrayBuffer"],function(t,a){r[a]&&e.isObservable(r[a])&&("objectURL"==a&&s.revokeObjectURL(r.objectURL()),r[a](null))}),a.value=""}),e.isObservable(n())&&n()(r)},a.onchange()},update:function(t,a){var n=e.utils.unwrapObservable(a()),r=e.isObservable(n.file)&&n.file();if(n.objectURL&&e.isObservable(n.objectURL)){var l=r&&s.createObjectURL(r);if(l){var i=n.objectURL();i&&s.revokeObjectURL(i),n.objectURL(l)}}n.base64String&&e.isObservable(n.base64String)&&(n.dataURL&&e.isObservable(n.dataURL)||(n.dataURL=e.observable())),["binaryString","text","dataURL","arrayBuffer"].forEach(function(t){var a="readAs"+(t.substr(0,1).toUpperCase()+t.substr(1));if(!("dataURL"==t||n[t]&&e.isObservable(n[t])))return!0;if(!r)return!0;var s=new FileReader;s.onload=function(s){if(n[t]&&n[t](s.target.result),"readAsDataURL"==a&&n.base64String&&e.isObservable(n.base64String)){var r=s.target.result.split(",");2===r.length&&n.base64String(r[1])}},s[a](r)})}},e.bindingHandlers.fileDrag={update:function(t,a){var s=e.utils.unwrapObservable(a())||{};t.dataset.fileDragInjected||(t.classList.add("filedrag"),t.ondragover=t.ondragleave=t.ondrop=function(n){if(n.stopPropagation(),n.preventDefault(),"dragover"==n.type?t.classList.add("hover"):t.classList.remove("hover"),"drop"==n.type&&n.dataTransfer){var r=n.dataTransfer.files,l=r[0];l&&(s.file(l),e.isObservable(a())&&a()(s))}},t.dataset.fileDragInjected=!0)}},e.bindingHandlers.customFileInput={init:function(s,n){if(e.utils.unwrapObservable(n())!==!1){var r=a.customFileInputSystemOptions,l=a.defaultOptions,i=t(s),o=t("<span>").addClass(r.wrapperClass).addClass(l.wrapperClass),u=t("<span>").addClass(r.buttonGroupClass).addClass(l.buttonGroupClass);u.append(t("<span>").addClass(r.buttonClass)),i.wrap(o).wrap(u);var u=i.parent("."+r.buttonClass).parent();u.before(t("<input>").attr("type","text").attr("disabled","disabled").addClass(r.fileNameClass)),i.before(t("<span>").addClass(r.buttonTextClass))}},update:function(s,n,r){var l=e.utils.unwrapObservable(n());if(l!==!1){l=l||{},l&&"object"!=typeof l&&(l={});var i=a.customFileInputSystemOptions,o=a.defaultOptions;l=t.extend(o,l);var u=r();if(u.fileInput){var b=e.utils.unwrapObservable(u.fileInput)||{},p=e.utils.unwrapObservable(b.file),f=t(s).parent(),d=f.parent(),c=d.parent();f.addClass(e.utils.unwrapObservable(l.buttonClass)),f.find("."+i.buttonTextClass).html(e.utils.unwrapObservable(p?l.changeButtonText:l.buttonText));var v=c.find("."+i.fileNameClass);v.addClass(e.utils.unwrapObservable(l.fileNameClass)),v.val(p&&p.name?p.name:e.utils.unwrapObservable(l.noFileText));var C=d.find("."+i.clearButtonClass);C.length||(C=t("<span>").addClass(i.clearButtonClass),C.on("click",function(){l.onClear(b,l)}),d.append(C)),C.html(e.utils.unwrapObservable(l.clearButtonText)),C.addClass(e.utils.unwrapObservable(l.clearButtonClass)),p&&l.clearButton&&p.name||C.remove()}}}},e.fileBindings=a,a});